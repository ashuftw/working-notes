...
**Step 2:** Integrate the constant: $$I(f) \approx \int_a^b f(m)dx = f(m) \cdot (b-a)$$

**Result:** $$\boxed{\int_a^b f(x)dx \approx (b-a)f\left(\frac{a+b}{2}\right)}$$
...
**Step 2:** The quadratic polynomial is: $$p_2(x) = f(a)L_0(x) + f(m)L_1(x) + f(b)L_2(x)$$
