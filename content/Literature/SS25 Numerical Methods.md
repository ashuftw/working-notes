...
1. **Compute using $\frac 3 8^{\text{th}}$ rule (Formula Given) and midpoint rule**
	$$
	I(f)=\int_0^1 18x^2-1\, dx
	$$
...
2.  **Use Improved Euler to approximate**
	$$
	y' = 4y+1, \quad y(0)= 0
	$$
...
1. **Translate the method into butcher table and provide the derivation in clear terms.**
	$$
	\text{long method}
	$$
