...
4. **Multiple Instruction Multiple Data (MIMD)**
	...
	![[../Files/Pasted image 20240425124029.png|center|500]]

## Terminology

1. **Core:** 
	- Arithmetic Unit + Control Unit, It conducts Float and Integer operations. 
2. **CPU:** 
	- Main processing Unit with several cores caches (these days.)
3. **Cache:** 
	- Fast Indexed Memory that keeps copies of data from the main memory. 
4. **RAM**: 
...
6. **Computing Power**
	- Maximum floating point operations per second (FLOPS) (Arithmetic)
	 - Modern Computers can merge addition and multiplication
7. **Thread**
